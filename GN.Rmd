...
The code from our catch-up-session can be found in file `2017-06-12.R`,
the transcript including in- and output is here: `2017-06-12.Rt`.
...
The code from our data.table session can be found in file `<date>.R`.
As usual, the transcript including in- and output is here: `<date>.Rt`.
